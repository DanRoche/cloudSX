<?php
   ...
   $msgs = Array(
     ...
     'menu_docs' => "Documents :",
     'menu_add' => "Add",
     'menu_add1' => "Some documents",
     'menu_addlnk' => "An external link",
     'menu_ren' => "Rename",
     'menu_del' => "Delete",
     'menu_getzip' => "Download",
     'menu_allzip' => "Download all",
     ...
     'err_tit' => "Error",
     'err_back' => "Back",
     'inv_tit' => "Invalid briefcase ID !",
     'inv_msg1' => "A mistake may occured in the URL, or more likely, the briefcase in question has been deleted in the meantime !",
     'inv_msg2' => "Please contact the issuer of this briefcase for verification of these informations.",
     'del_title' => "Documents removal",
     'del_m1' => "Confirm the removal of the following files ?",
     'del_confirm' => "Remove !",
     'del_err1' => "Please select some files to remove !",
     'zip_title' => "Multiple Download (zip format)",
     'zip_m1' => "You are about to download the following files",
     'zip_all' => "You are about to download all briefcase files",
     'zip_confirm' => "Download !",
     ...
     'idx_m1p3' => "share it, and collaborate. It's easy and fast !",
     'idx_pre1' => "<strong>More</strong> : with an account, you can :<br><ul><li>keep track and manage easily all your briefcases :<ul><li>yours,<li>those which where shared to you,</ul><li>not be bothered by passwords,<li>have a longer briefcase life, even unlimited (<i>premium</i>)<li>have your own logo. (<i>premium</i>)</ul>.",
     ...
     'mgt_dcnt' => "Your <span class='badge' id='DosCnt'>%s</span> briefcases :",
     ...
     'act_prem1' => "You have a premium account until %s",
     'act_renew' => "Renew",
     'act_noprem1' => "You do not have a premium account yet !",
     'act_noprem2' => "With this one you will be able to : <ul><li>extend your briefcase end of life limit.<li>personnalize your logo.</ul>",
     'act_noprem3' => "Enjoy the benefits of a premium account !",
     'act_pay' => "Upgrade your account to premium", 
     'act_paychoose' => "Account : <strong>%s</strong>, choose subcription period",
     'act_sandbox' => "BE CAREFUL , it is a test payment , the real payment is not effective yet !",
     ...
     'cont_orig' => "Original",
     'cont_dl' => "Download",
     'cont_newtab' => "View in a separate tab",
     'cont_previsu' => "This is an office document, you can see below a pdf preview",
     'cont_badpreview' => "This kind of office document can not be correctly previewed in a browser.",
     'cont_dlorig' => "Download original version",
     'cont_editonline' => "Edit directly online",
     'cont_helpvnd' => "Technical prerequisites",
     ...
     'acc_errnoinfo' => "Error : Impossible to create account !",
     ...
     'notauth1' => "You are not authenticated, although not required,",
     'notauth2' => "log in to your account",
     'notauth3' => "to take advantage of all the features",
     '1stdos1' => "This briefcase is not part of your list, if you want to be able to come back easily, consider ",
     '1stdos2' => "attach it to your account.",
     'fcre_title' => "Fast files sharing",
     'fcre_msg1' => "Your new briefcase :",
     'fcre_butn' => "Share files",
     'fcre_cont' => "Continue",
     'dav_title' => "Direct access to files",
     'dav_expln1' => "You can directly access and work with the briefcase files, <em>(DAV protocol)</em>",
     'dav_expln2' => "To do so, use the URL and the method suited to your computer :",
     'dav_pass1' => "Give the following identifier :",
     'dav_pass2' => "login:",
     'dav_pass3' => "password:",
     'dav_pass4' => "( the * character ! )",
     'adm_title' => "CloudSX Administration",
     'adm_mgmt' => "Briefcases Management",
     'adm_tabdlist' => "Briefcases",
     'adm_tabulist' => "Users",
     'adm_tabres' => "Results#%s",
     'adm_dcnt' => "there is <span class='badge' id='DosCnt'>%s</span> briefcases :",
     'adm_th1' => "name",
     'adm_th2' => "passwords",
     'adm_th3' => "users count",
     ...
     'adm_th5' => "end of life",
     'adm_th6' => "actions",
     'adm_ucnt' => "there is <span class='badge' id='UzrCnt'>%s</span> users :",
     ...
     'xapp_title' => "Add an application : ",
     'xapp_nam1' => "name",
     'xapp_nam2' => "Name for your application",
     'xapp_confirm' => "Validate",
     'xlnk_title' => "Add an external link : ",
     'xlnk_nam1' => "name:",
     'xlnk_nam2' => "Name of the link",
     'xlnk_url1' => "url:",
     'xlnk_url2' => "target URL for the link",
     'xlnk_color' => "color:",
     'xlnk_confirm' => "Validate",
);
