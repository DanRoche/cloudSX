...
class Savant3 {
	...
	*/
	...
	/**
	*
	* Set Messages - usually language dependent
	*
	* Addition by Daniel Roche : dan.y.roche@gmail.com
	*                            2014/06/16
	* 
	* @access public
	* 
	* @param array $msgs The array containing messages
	* 
	* @return void
	*
	*/
	...
	/**
	*
	* Display a message given the key
	*
	* Addition by Daniel Roche : dan.y.roche@gmail.com
	*                            2014/06/16
	* 
	* @access public
	* 
	* @param $key The key form the message array
	* 
	* @return void
	*
	*/
	...
	public function M1($key,$a1)
	{
	  if ( isset($this->MSGS[$key] ) ) {
	    printf($this->MSGS[$key], $a1);
	  } else {
	    echo $key." ".$a1;
	  }
	}

	public function M2($key,$a1,$a2)
	{
	  if ( isset($this->MSGS[$key] ) ) {
	    printf($this->MSGS[$key], $a1,$a2);
	  } else {
	    echo $key." ".$a1." ".$a2;
	  }
	}
